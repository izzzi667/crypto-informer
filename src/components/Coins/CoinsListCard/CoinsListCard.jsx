    ...
    return <Col>
            <Card style={{ width: '13.2rem' }} bg={'light'}>
                ...
                <ListGroup variant="flush">
                    <ListGroup.Item variant={varianValue}>Price: {props.coinInfo.current_price}$ </ListGroup.Item>
                    <ListGroup.Item variant={varianValue}>Price change 24h:<br /> {props.coinInfo.price_change_24h}<ThrendingIcon value={props.coinInfo.price_change_24h}/> </ListGroup.Item>
